...
/**
 * Decompiles Java classes with the Fernflower decompiler (<a href="https://github.com/JetBrains/intellij-community/tree/master/plugins/java-decompiler/engine">...</a>)
 *
 *
                ...
                throws DecompilationException
    {
        ...
        try
        {
            ...
            while (entries.hasMoreElements())
            {
                ...
                IBytecodeProvider bytecodeProvider = (externalPath, internalPath) -> InterpreterUtil.getBytes(jar, entry);
